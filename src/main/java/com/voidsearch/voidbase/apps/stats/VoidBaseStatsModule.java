...
package com.voidsearch.voidbase.apps.stats;
...
public class VoidBaseStatsModule implements VoidBaseModule {
    ...
    public VoidBaseModuleResponse handle(VoidBaseModuleRequest request) throws VoidBaseModuleException {
        return new VoidBaseModuleResponse(supervisor.getStats());
    }
